...
const PropertyPreview = () => {
    ...
    return (
        <section class="text-gray-600 body-font overflow-hidden">
            ...
            <div>
                <Link to="/" className='bg-blue-500 py-3 px-6 rounded-lg text-white font-medium'>Back</Link>
            </div>
                <div class="lg:w-4/5 mx-auto flex flex-wrap">
                    <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                        <h2 class="text-sm title-font text-gray-500 tracking-widest">{property.city}</h2>
                        <h1 class="text-gray-900 text-3xl title-font font-medium mb-4">{property.name}</h1>
                        <div class="flex mb-4">
                    ...
                    <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={property?.image} />
                </div>
            </div>
        </section>
    );
